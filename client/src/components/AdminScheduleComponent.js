            ...
            <Table bordered hover size="sm">
              ...
              <tbody>
                {this.state.teachers
                  .filter(
                    (cstudent) =>
                      cstudent.campus.id === this.state?.campus?.id ||
