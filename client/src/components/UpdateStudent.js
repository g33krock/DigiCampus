...
export class StudentUpdater extends Component {
  ...
  async updateStudent() {
    const studentObject = {
      ...
      paraHours: document.getElementById("paraHours").value,
      district: document.getElementById("district").value,
      start: document.getElementById("start").value,
      SAIS: document.getElementById("SAIS").value,
      counselingBTD: document.getElementById("counselingBTD").value,
      speechBTD: document.getElementById("speechBTD").value,
      otBTD: document.getElementById("otBTD").value,
      ptBTD: document.getElementById("ptBTD").value,
      musicBTD: document.getElementById("musicBTD").value,
      abaBTD: document.getElementById("abaBTD").value,
    };
            ...
            <ModalBody>
              <Form>
                ...
                <Row>
                  ...
                  <Col>
                    <FormGroup>
                      <Label for="studentInstructionMode">
                        Instruction Mode
                      </Label>
                      <Input
                        type="select"
                ...
                <Row>
                  ...
                  <Col>
                    <FormGroup>
                      <Label for="SAIS">SAIS</Label>
                      <Input
                        defaultValue={this.props.SAIS}
                        type="text"
                        name="SAIS"
                        id="SAIS"
                      />
                  ...
                  <Col>
                    <FormGroup>
                      <Label for="previousSchools"><small>Previous School(s)</small></Label>
                      <Input
                ...
                <Container>
                  ...
                  <Row>
                    <Col>
                      <FormGroup>
                        <Label for="teacherHours">Teacher</Label>
                        <Input
                          type="number"
                          name="teacherHours"
                          id="teacherHours"
                          placeholder="must be a number!"
                          defaultValue={this.props.teacherHours}
                        />
                      </FormGroup>
                    </Col>
                    <Col>
                      <FormGroup>
                        <Label for="paraHours">Para</Label>
                        <Input
                          type="number"
                          name="paraHours"
                          id="paraHours"
                          placeholder="must be a number!"
                          defaultValue={this.props.paraHours}
                        />
                      </FormGroup>
                    </Col>
                  </Row>
                ...
                <Container>
                  ...
                  <Row>
                    <Col>
                      ...
                      <FormGroup>
                        <Input
                          ...
                          name="counselingBTD"
                          id="counselingBTD"
                          defaultValue={this.props?.counselingBTD}
                          placeholder="Bill To:"
                        >
                          <option></option>
                    ...
                    <Col>
                      ...
                      <FormGroup>
                        <Input
                          ...
                          name="speechBTD"
                          id="speechBTD"
                          defaultValue={this.props?.speechBTD}
                          placeholder="Bill To:"
                        >
                          <option></option>
                          <option>District</option>
                    ...
                    <Col>
                      <FormGroup>
                        <Label for="otMinutes">
                          <small>Occupational Therapy</small>
                        </Label>
                        <Input
                          type="number"
                          name="otMinutes"
                          id="otMinutes"
                          placeholder="minutes"
                          defaultValue={this.props.otMinutes}
                        />
                      </FormGroup>
                      <FormGroup>
                        <Input
                  ...
                  <Row>
                    <Col>
                      <FormGroup>
                        <Label for="abaMinutes">
                          <small>ABA Therapy</small>
                        </Label>
                        <Input
                          type="number"
                          name="abaMinutes"
                      ...
                      <FormGroup>
                        <Input
                          ...
                          name="abaBTD"
                          id="abaBTD"
                          defaultValue={this.props?.abaBTD}
                          placeholder="Bill To:"
                        >
                          <option></option>
                          <option>District</option>
                    ...
                    <Col>
                      <FormGroup>
                        <Label for="musicMinutes">
                          <small>Music Therapy</small>
                        </Label>
                        <Input
                          type="number"
                          name="musicMinutes"
                          id="musicMinutes"
                          placeholder="minutes"
                          defaultValue={this.props.musicMinutes}
                        />
                      </FormGroup>
                      <FormGroup>
                        <Input
                      ...
                      <FormGroup>
                        <Input
                          ...
                          name="musicBTD"
                          id="musicBTD"
                          defaultValue={this.props?.musicBTD}
                          placeholder="Bill To:"
                        >
                          <option></option>
                          <option>District</option>
